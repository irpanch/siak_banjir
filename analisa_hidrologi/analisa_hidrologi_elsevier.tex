...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Analisa Hidrologi Sungai Siak},
            colorlinks=false,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  \title{Analisa Hidrologi Sungai Siak}
    \author[Institut Teknologi Bandung]{Irpan Chumaedi\corref{1}}
   \ead{irpanch@gmail.com} 
      \address[Institut Teknologi Bandung]{Civil and Environment
Faculty, Jalan Ganesha, Bandung, Jawa Barat, 40132}
      \cortext[1]{Postgraduate Student at Institut Teknologi Bandung}
